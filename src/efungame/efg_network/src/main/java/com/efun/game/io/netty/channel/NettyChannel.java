 ...
 */
package com.efun.game.io.netty.channel;
...
import com.efun.game.io.remoting.transport.AbstractChannel;
...
public final class NettyChannel extends AbstractChannel {
    ...
    private NettyChannel(Channel channel, ChannelHandler handler){
        super(handler);
        if (null == channel) {
    ...
    public static NettyChannel getOrAddChannel(Channel ch, ChannelHandler handler) {
        if (ch == null) {
            return null;
        }
