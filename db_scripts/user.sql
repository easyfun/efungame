...
(
    ...
    marriage_status tinyint default '0' comment '婚姻状态: 1-未婚; 2-已婚; 3-保密',
...
#uid与mobile关系映射表
create table t_uid_with_mobile
(
    uid bigint not null comment 'uid',
...
#uid与user_name关系映射表
create table t_uid_with_user_name
(
    uid bigint not null comment 'uid',
    user_name varchar(64) not null comment '用户名',
    used_status tinyint not null default '0' comment '使用状态: 0-正常; 1-禁用',
